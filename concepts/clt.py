def plot_clt():
    ...
    st.write(f"With sample size {sample_size} and {num_samples} samples, we observe how the distribution of sample means resembles a normal distribution even though the original data follows a {distribution_type} distribution.")
