def plot_binomial_to_poisson():
    ...
    st.write("We observe that as n increases and p decreases, the binomial distribution approximates the Poisson distribution more closely.")
